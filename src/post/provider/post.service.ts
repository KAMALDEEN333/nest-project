...
export class PostsService {
    ...
    // Mthod to GET all post that was sent in an array[]
    ...
    // public  FindAllposts(postQuery:GetPostsDto) : Promise<Post[]> {
    ...
    // method to get all post with the metaoptions
...
// }
    ...
    public async deleteOne (id: number) {
        ...
        // let inverPost = await this.metaRepository.find({
